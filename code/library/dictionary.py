...
VARIABLE_LABELS: dict[str, str] = {
    ...
    "fuel_total": "Monthly fuel spending",
    "transport_total": "Monthly transport spending",
    "transport_spending_mo": "Monthly transport spending",
    "fuel_transport_total": "Monthly fuel + transport spending",
    "total_mo": "Total monthly household spending",
